...
Subject : Streamlit with Demande de valeurs foncières
"""
...
def plot_map(df_):
    ...
    col1, col2 = st.columns(2)
    #col1.st.write("")
    col1.metric("Nombre de transactions sur cette période :", len(points),len(points) - (len(points)/578325)*1.5) )))
    st.map(points)
